...
class RadarInfo(metaclass=Metaclass_RadarInfo):
    ...
    def __init__(self, **kwargs):
        ...
        self.radar_info = kwargs.get('radar_info', int())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.radar_info != other.radar_info:
            return False
        return True
    ...
    @builtins.property
    def radar_info(self):
        """Message field 'radar_info'."""
        return self._radar_info

    @radar_info.setter
    def radar_info(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'radar_info' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'radar_info' field must be an unsigned integer in [0, 255]"
        self._radar_info = value
