...
#ifndef RM_REFEREE_MSGS__MSG__DETAIL__CUSTOM_CONTROL__FUNCTIONS_H_
#define RM_REFEREE_MSGS__MSG__DETAIL__CUSTOM_CONTROL__FUNCTIONS_H_
 ...
 * calls
 * rm_referee_msgs__msg__CustomControl__init().
...
/**
 * It calls
 * rm_referee_msgs__msg__CustomControl__fini()
 ...
 * rm_referee_msgs__msg__CustomControl__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rm_referee_msgs__msg__CustomControl__Sequence__fini()
 * on the array,
...
#endif  // RM_REFEREE_MSGS__MSG__DETAIL__CUSTOM_CONTROL__FUNCTIONS_H_
