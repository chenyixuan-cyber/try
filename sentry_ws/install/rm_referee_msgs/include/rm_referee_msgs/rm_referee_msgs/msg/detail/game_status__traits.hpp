...
#ifndef RM_REFEREE_MSGS__MSG__DETAIL__GAME_STATUS__TRAITS_HPP_
#define RM_REFEREE_MSGS__MSG__DETAIL__GAME_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const rm_referee_msgs::msg::GameStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rm_referee_msgs::msg::GameStatus & msg)
{
  return rm_referee_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rm_referee_msgs::msg::GameStatus>()
{
  return "rm_referee_msgs::msg::GameStatus";
}

template<>
inline const char * name<rm_referee_msgs::msg::GameStatus>()
{
  return "rm_referee_msgs/msg/GameStatus";
}

template<>
struct has_fixed_size<rm_referee_msgs::msg::GameStatus>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<rm_referee_msgs::msg::GameStatus>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<rm_referee_msgs::msg::GameStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // RM_REFEREE_MSGS__MSG__DETAIL__GAME_STATUS__TRAITS_HPP_
