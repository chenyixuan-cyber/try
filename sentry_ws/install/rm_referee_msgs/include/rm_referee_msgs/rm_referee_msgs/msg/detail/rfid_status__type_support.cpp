...
{
  new (message_memory) rm_referee_msgs::msg::RFIDStatus(_init);
}

void RFIDStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_referee_msgs::msg::RFIDStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RFIDStatus_message_member_array[3] = {
  {
    ...
    offsetof(rm_referee_msgs::msg::RFIDStatus, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_referee_msgs::msg::RFIDStatus, rfid_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_referee_msgs::msg::RFIDStatus, rfid_status_2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RFIDStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(rm_referee_msgs::msg::RFIDStatus),
...
{
  return &::rm_referee_msgs::msg::rosidl_typesupport_introspection_cpp::RFIDStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_referee_msgs, msg, RFIDStatus)() {
  return &::rm_referee_msgs::msg::rosidl_typesupport_introspection_cpp::RFIDStatus_message_type_support_handle;
}
