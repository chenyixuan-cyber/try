...
#define NODE_MAIN_LOGGER_NAME "tf_publisher"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtf_publisher_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<TfPublisher>";
