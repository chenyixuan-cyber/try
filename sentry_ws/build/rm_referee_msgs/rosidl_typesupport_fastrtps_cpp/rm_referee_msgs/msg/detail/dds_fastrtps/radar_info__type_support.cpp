...
#include "rm_referee_msgs/msg/detail/radar_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_referee_msgs::msg::RadarInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_referee_msgs::msg::RadarInfo & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs::msg::RadarInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_msgs::msg::RadarInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_msgs::msg::RadarInfo *>(
    untyped_ros_message);
...
{
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_RadarInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_msgs, msg, RadarInfo)() {
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_RadarInfo__handle;
}
