...
#include "rm_referee_msgs/msg/detail/game_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_referee_msgs::msg::GameStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_referee_msgs::msg::GameStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs::msg::GameStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_msgs::msg::GameStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_msgs::msg::GameStatus *>(
    untyped_ros_message);
...
{
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_GameStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_msgs, msg, GameStatus)() {
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_GameStatus__handle;
}
