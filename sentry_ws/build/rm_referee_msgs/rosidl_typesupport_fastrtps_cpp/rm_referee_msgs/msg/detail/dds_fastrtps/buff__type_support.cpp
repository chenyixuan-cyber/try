...
#include "rm_referee_msgs/msg/detail/buff__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs::msg::Buff;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_msgs::msg::Buff *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_msgs::msg::Buff *>(
    untyped_ros_message);
...
{
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_Buff__handle;
}
