...
#include "rm_referee_msgs/msg/detail/keyboard_mouse_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_referee_msgs::msg::KeyboardMouseControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_referee_msgs::msg::KeyboardMouseControl & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rm_referee_msgs
max_serialized_size_KeyboardMouseControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs::msg::KeyboardMouseControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_msgs::msg::KeyboardMouseControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_msgs::msg::KeyboardMouseControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _KeyboardMouseControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rm_referee_msgs::msg::KeyboardMouseControl *>(
...
static size_t _KeyboardMouseControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_KeyboardMouseControl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _KeyboardMouseControl__callbacks = {
  "rm_referee_msgs::msg",
...
static rosidl_message_type_support_t _KeyboardMouseControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_KeyboardMouseControl__callbacks,
...
{
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_KeyboardMouseControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_msgs, msg, KeyboardMouseControl)() {
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_KeyboardMouseControl__handle;
}
