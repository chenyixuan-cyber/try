...
#include "rm_referee_msgs/msg/detail/power_heat_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_referee_msgs::msg::PowerHeatData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_referee_msgs::msg::PowerHeatData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs::msg::PowerHeatData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_referee_msgs::msg::PowerHeatData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_referee_msgs::msg::PowerHeatData *>(
    untyped_ros_message);
...
{
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_PowerHeatData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_msgs, msg, PowerHeatData)() {
  return &rm_referee_msgs::msg::typesupport_fastrtps_cpp::_PowerHeatData__handle;
}
