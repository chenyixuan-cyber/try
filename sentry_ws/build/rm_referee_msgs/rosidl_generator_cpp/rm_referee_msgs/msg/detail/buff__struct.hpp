...
#ifndef RM_REFEREE_MSGS__MSG__DETAIL__BUFF__STRUCT_HPP_
#define RM_REFEREE_MSGS__MSG__DETAIL__BUFF__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rm_referee_msgs__msg__Buff __attribute__((deprecated))
#else
# define DEPRECATED__rm_referee_msgs__msg__Buff __declspec(deprecated)
#endif
...
struct Buff_
{
  ...
  // pointer types
  using RawPtr =
    rm_referee_msgs::msg::Buff_<ContainerAllocator> *;
  using ConstRawPtr =
    const rm_referee_msgs::msg::Buff_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rm_referee_msgs::msg::Buff_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rm_referee_msgs__msg__Buff
    std::shared_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rm_referee_msgs__msg__Buff
    std::shared_ptr<rm_referee_msgs::msg::Buff_<ContainerAllocator> const>
...
using Buff =
  rm_referee_msgs::msg::Buff_<std::allocator<void>>;
...
#endif  // RM_REFEREE_MSGS__MSG__DETAIL__BUFF__STRUCT_HPP_
