...
static const _RobotCustomData2_type_support_symbol_names_t _RobotCustomData2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_referee_msgs, msg, RobotCustomData2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_referee_msgs, msg, RobotCustomData2)),
  }
};
...
{
  return &::rm_referee_msgs::msg::rosidl_typesupport_cpp::RobotCustomData2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_referee_msgs, msg, RobotCustomData2)() {
  return get_message_type_support_handle<rm_referee_msgs::msg::RobotCustomData2>();
}
