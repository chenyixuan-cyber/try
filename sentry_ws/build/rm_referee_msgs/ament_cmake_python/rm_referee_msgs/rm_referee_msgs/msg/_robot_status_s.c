...
bool rm_referee_msgs__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_msgs.msg._robot_status.RobotStatus", full_classname_dest, 45) == 0);
  }
  rm_referee_msgs__msg__RobotStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // bullet_speed_limit
    PyObject * field = PyObject_GetAttrString(_pymsg, "bullet_speed_limit");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->bullet_speed_limit = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // power_management_gimbal_output
    ...
    ros_message->power_management_gimbal_output = (Py_True == field);
    Py_DECREF(field);
  }
  {  // power_management_chassis_output
    ...
    assert(PyBool_Check(field));
    ros_message->power_management_chassis_output = (Py_True == field);
    Py_DECREF(field);
  }
  {  // power_management_shooter_output
    ...
    assert(PyBool_Check(field));
    ros_message->power_management_shooter_output = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * rm_referee_msgs__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_msgs.msg._robot_status");
  ...
  {  // bullet_speed_limit
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->bullet_speed_limit);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bullet_speed_limit", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // power_management_gimbal_output
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->power_management_gimbal_output ? 1 : 0);
    {
  ...
  {  // power_management_chassis_output
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->power_management_chassis_output ? 1 : 0);
    {
  ...
  {  // power_management_shooter_output
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->power_management_shooter_output ? 1 : 0);
    {
