...
bool rm_referee_msgs__msg__dart_client_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_msgs.msg._dart_client_cmd.DartClientCmd", full_classname_dest, 50) == 0);
  }
  rm_referee_msgs__msg__DartClientCmd * ros_message = _ros_message;
  {  // header
  ...
  {  // latest_launch_cmd_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "latest_launch_cmd_time");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->latest_launch_cmd_time = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * rm_referee_msgs__msg__dart_client_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_msgs.msg._dart_client_cmd");
  ...
  {  // latest_launch_cmd_time
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->latest_launch_cmd_time);
    {
      int rc = PyObject_SetAttrString(_pymessage, "latest_launch_cmd_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
