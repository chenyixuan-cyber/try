...
#include "rm_referee_msgs/msg/detail/radar_info__rosidl_typesupport_fastrtps_c.h"
...
using _RadarInfo__ros_msg_type = rm_referee_msgs__msg__RadarInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: radar_info
  {
    cdr << ros_message->radar_info;
  }
...
size_t get_serialized_size_rm_referee_msgs__msg__RadarInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RadarInfo__ros_msg_type * ros_message = static_cast<const _RadarInfo__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name radar_info
  {
    size_t item_size = sizeof(ros_message->radar_info);
...
static uint32_t _RadarInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_referee_msgs__msg__RadarInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_referee_msgs
size_t max_serialized_size_rm_referee_msgs__msg__RadarInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs__msg__RadarInfo;
    is_plain =
      (
      offsetof(DataType, radar_info) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _RadarInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_referee_msgs__msg__RadarInfo(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_referee_msgs, msg, RadarInfo)() {
