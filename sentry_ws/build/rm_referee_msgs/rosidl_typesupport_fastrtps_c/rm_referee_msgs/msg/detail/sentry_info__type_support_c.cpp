...
#include "rm_referee_msgs/msg/detail/sentry_info__rosidl_typesupport_fastrtps_c.h"
...
using _SentryInfo__ros_msg_type = rm_referee_msgs__msg__SentryInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: sentry_info_3
  {
    cdr << ros_message->sentry_info_3;
  }
...
size_t get_serialized_size_rm_referee_msgs__msg__SentryInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SentryInfo__ros_msg_type * ros_message = static_cast<const _SentryInfo__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name sentry_info_3
  {
    size_t item_size = sizeof(ros_message->sentry_info_3);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _SentryInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_referee_msgs__msg__SentryInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_referee_msgs
size_t max_serialized_size_rm_referee_msgs__msg__SentryInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs__msg__SentryInfo;
    is_plain =
      (
      offsetof(DataType, sentry_info_3) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _SentryInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_referee_msgs__msg__SentryInfo(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_referee_msgs, msg, SentryInfo)() {
