...
#include "rm_referee_msgs/msg/detail/game_robot_hp__rosidl_typesupport_fastrtps_c.h"
...
using _GameRobotHP__ros_msg_type = rm_referee_msgs__msg__GameRobotHP;
...
size_t get_serialized_size_rm_referee_msgs__msg__GameRobotHP(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GameRobotHP__ros_msg_type * ros_message = static_cast<const _GameRobotHP__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GameRobotHP__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_referee_msgs__msg__GameRobotHP(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_referee_msgs
size_t max_serialized_size_rm_referee_msgs__msg__GameRobotHP(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs__msg__GameRobotHP;
    is_plain =
      (
...
static size_t _GameRobotHP__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_referee_msgs__msg__GameRobotHP(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_referee_msgs, msg, GameRobotHP)() {
