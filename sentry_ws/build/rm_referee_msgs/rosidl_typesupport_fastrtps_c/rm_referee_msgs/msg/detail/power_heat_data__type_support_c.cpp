...
#include "rm_referee_msgs/msg/detail/power_heat_data__rosidl_typesupport_fastrtps_c.h"
...
using _PowerHeatData__ros_msg_type = rm_referee_msgs__msg__PowerHeatData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: shooter_42mm_barrel_heat
  {
    cdr << ros_message->shooter_42mm_barrel_heat;
  }
...
size_t get_serialized_size_rm_referee_msgs__msg__PowerHeatData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PowerHeatData__ros_msg_type * ros_message = static_cast<const _PowerHeatData__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name shooter_42mm_barrel_heat
  {
    size_t item_size = sizeof(ros_message->shooter_42mm_barrel_heat);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _PowerHeatData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_referee_msgs__msg__PowerHeatData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_referee_msgs
size_t max_serialized_size_rm_referee_msgs__msg__PowerHeatData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_referee_msgs__msg__PowerHeatData;
    is_plain =
      (
      offsetof(DataType, shooter_42mm_barrel_heat) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PowerHeatData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_referee_msgs__msg__PowerHeatData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_referee_msgs, msg, PowerHeatData)() {
