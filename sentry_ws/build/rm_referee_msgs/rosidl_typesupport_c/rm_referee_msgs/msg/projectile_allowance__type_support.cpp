...
static const _ProjectileAllowance_type_support_symbol_names_t _ProjectileAllowance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_referee_msgs, msg, ProjectileAllowance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_referee_msgs, msg, ProjectileAllowance)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_referee_msgs, msg, ProjectileAllowance)() {
  return &::rm_referee_msgs::msg::rosidl_typesupport_c::ProjectileAllowance_message_type_support_handle;
}
