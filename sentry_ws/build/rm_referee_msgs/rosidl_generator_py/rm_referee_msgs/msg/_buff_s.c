...
bool rm_referee_msgs__msg__buff__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_msgs.msg._buff.Buff", full_classname_dest, 30) == 0);
  }
  rm_referee_msgs__msg__Buff * ros_message = _ros_message;
  {  // header
  ...
  {  // cooling_buff
    ...
    assert(PyLong_Check(field));
    ros_message->cooling_buff = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // defence_buff
...
PyObject * rm_referee_msgs__msg__buff__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_msgs.msg._buff");
