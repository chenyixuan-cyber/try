    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rm_referee_msgs.msg.RFIDStatus')
            logger.debug(
...
class RFIDStatus(metaclass=Metaclass_RFIDStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.rfid_status_2 = kwargs.get('rfid_status_2', int())
    ...
    def __eq__(self, other):
        ...
        if self.rfid_status != other.rfid_status:
            return False
        if self.rfid_status_2 != other.rfid_status_2:
            return False
        return True
    ...
    @builtins.property
    def rfid_status_2(self):
        """Message field 'rfid_status_2'."""
        return self._rfid_status_2

    @rfid_status_2.setter
    def rfid_status_2(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'rfid_status_2' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'rfid_status_2' field must be an unsigned integer in [0, 255]"
        self._rfid_status_2 = value
