...
bool rm_referee_msgs__msg__hurt_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_msgs.msg._hurt_data.HurtData", full_classname_dest, 39) == 0);
  }
  rm_referee_msgs__msg__HurtData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of HurtData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_msgs.msg._hurt_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HurtData");
