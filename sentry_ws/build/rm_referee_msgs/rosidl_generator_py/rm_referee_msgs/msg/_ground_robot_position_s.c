...
bool rm_referee_msgs__msg__ground_robot_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_referee_msgs.msg._ground_robot_position.GroundRobotPosition", full_classname_dest, 62) == 0);
  }
  rm_referee_msgs__msg__GroundRobotPosition * ros_message = _ros_message;
  {  // header
  ...
  {  // reserved_2
    ...
    assert(PyFloat_Check(field));
    ros_message->reserved_2 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * rm_referee_msgs__msg__ground_robot_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_referee_msgs.msg._ground_robot_position");
  ...
  {  // reserved_2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->reserved_2);
    {
