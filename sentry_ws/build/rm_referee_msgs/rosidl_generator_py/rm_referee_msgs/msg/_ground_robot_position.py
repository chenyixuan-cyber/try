    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rm_referee_msgs.msg.GroundRobotPosition')
            logger.debug(
...
class GroundRobotPosition(metaclass=Metaclass_GroundRobotPosition):
    ...
    def __init__(self, **kwargs):
        ...
        self.reserved_2 = kwargs.get('reserved_2', float())
    ...
    def reserved_2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'reserved_2' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'reserved_2' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
